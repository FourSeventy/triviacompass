...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  #
  config.vm.provision :shell, path: "./vagrantScripts/vagrant_bootstrap.sh", privileged: false
  ...
  #
   config.vm.provision :shell, path: "./vagrantScripts/app_specific.sh", privileged: false
